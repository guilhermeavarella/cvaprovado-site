...
export default function Home() {
  ...
  return (
    <div className="w-full bg-[var(--background-default)] flex flex-col items-center justify-start">
      ...
      <div className="absolute top-0 w-full h-[54rem] flex flex-col items-center overflow-visible">
        ...
        <img src={heroImage} className="w-full h-[6.25rem] mt-[-3.5rem] md:mt-[-5.5rem]"/>
      </div>

      {/* Landing section */}
      <section className="w-full flex flex-col items-center justify-start z-1 px-4 py-12 md:py-16 md:px-90">
        <div className="w-full flex flex-col items-center text-[var(--content-inverse)] gap-16 md:px-42">
          <div>
            <h1 className="w-full text-center">
              SEU CURRÍCULO PODE ESTAR TE ELIMINANDO SEM VOCÊ SABER
            </h1>
            <p className="w-full text-center mt-4 md:text-lg md:px-54">
          ...
          <div className="w-full flex flex-col items-center justify-center gap-8">
            <div className="w-full h-67.5 bg-black md:w-160 md:h-90"/> {/* Placeholder for video */}
            {isLargeScreen ? (
      ...
      <section className="w-full flex flex-col items-center justify-start px-4 py-12 md:py-16 md:px-90">

        {/* Identification card */}
        <div className="w-full flex flex-col items-center bg-[var(--background-accent)] rounded-2xl p-8 md:p-16 gap-12 md:justify-between md:flex-row">
          <div className="flex flex-col gap-6">
            ...
            <h5 className="text-center text-[var(--brand-secondary)] md:text-start">
      ...
      <section className="w-full flex flex-col items-center justify-start px-4 py-12 md:py-16 md:px-90">
        <div className="w-full flex flex-col justify-center gap-16 md:gap-16">
          <div className="w-full flex flex-col gap-6 md:max-w-200">
            <h4>
      ...
      {/* Services section */}
      <section className="w-full flex flex-col items-center justify-start px-4 py-12 md:py-16 md:px-90">
        <div className="text-3xl md:text-4xl font-[Geologica] font-semibold mb-12">Conheça os serviços inclusos</div>
      ...
      {/* Reports section */}
      <section className="w-full max-w-screen flex flex-col items-center justify-start py-12 md:py-16">
        <div className="text-3xl md:text-4xl font-[Geologica] font-semibold mb-12">Histórias de sucesso</div>
        ...
        <EmblaCarousel slides={[
          ...reports.map((report, index) => (
            <div key={index} className="w-full h-full flex flex-col items-center justify-center text-[var(--content-inverse)] p-8 gap-4">
              ...
              <div className="text-center text-xl md:text-2xl font-[Geologica] font-semibold mt-3">{report.name}</div>
      ...
      {/* Final section */}
      <section className="w-full flex flex-col items-center justify-start px-4 py-12 md:py-16 md:px-90">
        <div className="w-full flex flex-col items-center justify-center md:flex-row gap-8 md:px-16 md:gap-32">
          <div className="w-full flex flex-col items-center justify-center gap-2 md:mx-12">
          ...
          <div className="w-full flex flex-col items-center justify-center gap-6">
            <div className="text-center md:text-start text-3xl font-[Geologica] font-semibold">Transformo sua busca em sucesso garantido</div>
            <div>
